...
# 51 "mcc_generated_files/usb/usb_hal_pic18.h"
...
volatile uint8_t CtrlTrfData[16] __attribute__((address(((0x400 +(((2 + 1) * 4)*4)) + 16))));
...
void USBDeviceAttach(void)
{
    ...
    if(USBDeviceState == DETACHED_STATE)
    {
        if(1 == 1)
        {
            ...
            {IPR3bits.USBIP = 1;PIE3bits.USBIE = 1;};
...
static void USBCtrlTrfTxService(void)
{
    ...
    byteToSend = 16;
    if(inPipes[0].wCount.Val < (uint8_t)16)
    {
