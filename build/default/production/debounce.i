...
_Bool pushButtonStatus = 1;



_Bool checkPushButton(_Bool pushButtonPin);
# 11 "debounce.c" 2
...
_Bool checkPushButton(_Bool pushButtonPin)
{
    ...
    _Bool button_state = pushButtonPin;


    if(button_state == 0 && button_state != pushButtonStatus)
    {
    ...
    if(button_state == 1 && button_state != pushButtonStatus)
    {
