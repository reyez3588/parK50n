...
void backLightOFF(void)
{
    ...
    I2C1_WriteNBytes(0b0100111, &stateLight, 1);
    return;
}
...
void SetCGRamAddr(unsigned char CGaddr)
{
    ...
    I2C1_WriteNBytes(0b0100111, &dataOut, 1);
...
void WriteDataXLCD(char data)
{
    ...
    dataOut = (data & 0xF0) + (stateLight | 0b00000001);
    I2C1_WriteNBytes(0b0100111, &dataOut, 1);
    ...
    dataOut = (data << 4) + (stateLight | 0b00000001);
    I2C1_WriteNBytes(0b0100111, &dataOut, 1);
