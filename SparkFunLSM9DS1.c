...
Original Creation Date: Julio 1, 2021


This file implements all functions of the LSM9DS1. Functions here range
...
{
    //struct IMUCongif IMUSettings;
    IMUSettings.gyro.enabled = true;
    IMUSettings.gyro.enableX = true;
    IMUSettings.gyro.enableY = true;
    IMUSettings.gyro.enableZ = true;
    ...
    IMUSettings.gyro.lowPowerEnable = false;
    IMUSettings.gyro.HPFEnable = false;
    ...
    IMUSettings.gyro.flipX = false;
    IMUSettings.gyro.flipY = false;
    IMUSettings.gyro.flipZ = false;
    IMUSettings.gyro.orientation = 0;
    IMUSettings.gyro.latchInterrupt = true;
    

    IMUSettings.accel.enabled = true;
    IMUSettings.accel.enableX = true;
    IMUSettings.accel.enableY = true;
    IMUSettings.accel.enableZ = true;
    ...
    IMUSettings.accel.highResEnable = false;
    ...
    IMUSettings.mag.tempCompensationEnable = false;
    ...
    IMUSettings.mag.lowPowerEnable = false;
...
uint16_t LSM9DS1begin()//uint8_t agAddress, uint8_t mAddress)//, TwoWire &wirePort)
{
    
	// Set device settings, they are used in many other places
    IMUSettings.device.commInterface = IMU_MODE_I2C;
    IMUSettings.device.agAddress = LSM9DS1_AG_ADDR; //agAddress
    IMUSettings.device.mAddress = LSM9DS1_M_ADDR; //mAddress;
    IMUSettings.device.i2c = true;
...
void LSM9DS1calibrateMag(bool loadIn)
{
	int i, j;
...
//	else if (IMUSettings.device.commInterface == IMU_MODE_SPI)
...
//    
//	IMUSettings.device.i2c.LSM9DS1beginTransmission(address);  // Initialize the Tx buffer
