...
This file prototypes the LSM9DS1, implemented in SFE_LSM9DS1.c. In
...
extern volatile	int16_t gx, gy, gz; // x, y, and z axis readings of the gyroscope
extern volatile	int16_t ax, ay, az; // x, y, and z axis readings of the accelerometer
extern volatile	int16_t mx, my, mz; // x, y, and z axis readings of the magnetometer
extern volatile    int16_t temperature; // Chip temperature
...
//	//   **For SPI use "beginSPI()", and only send first two address arguments.
	...
	uint16_t LSM9DS1begin(void);//By default use the default I2C addres, and use Wire port
...
//	void LSM9DS1configInt(interrupt_select interupt, uint8_t generator,
//				   h_lactive activeLow = INT_ACTIVE_LOW, enum pp_od pushPull = INT_PUSH_PULL);
